...
*/
void SAM3X8EClass::enable_main_oscillator(void)
{
...
/*
    ...
    0: OK
*/
uint8_t SAM3X8EClass::wait_for_main_oscillator(void)
{
    uint16_t i = 0;
...
/*
    ...
    12MHz * 14 = 168MHz
*/
void SAM3X8EClass::set_pll_and_divider(void)
{
    PMC_WPMR = WPKEY | WPEN_0;
...
/*
    ...
    0: OK
*/
uint8_t SAM3X8EClass::wait_for_pll(void)
{
    uint16_t i = 0;
...
/*
    ...
    0: OK
*/
uint8_t SAM3X8EClass::select_master_clock(void)
{
    PMC_WPMR = WPKEY | WPEN_0;
...
/*
    ...
    0: OK
*/
uint8_t SAM3X8EClass::wait_for_master_clock(void)
{
    uint16_t i = 0;
...
*/
void SAM3X8EClass::check_main_oscillator_frequency(void)
{
...
/*
    ...
    flash.
*/
void SAM3X8EClass::change_flash_read_waitstate(int waitstate)
{
...
/*
    ...
    0: OK
*/
uint8_t SAM3X8EClass::init_clock(void)
{
    uint8_t i = 0;
